...
import com.earn.common.config.Exception.BDException;
import com.earn.system.entity.ColumnDO;
import com.earn.system.entity.TableDO;
...
public class GenUtils {
    ...
    public static void generatorCode(Map<String, String> table, List<Map<String, String>> columns,
        ...
        // 表名转换成Java类名
        String className =
            tableToJava(tableDO.getTableName(), config.getString("tablePrefix"), config.getString("autoRemovePre"));
        tableDO.setClassName(className);
        tableDO.setClassname(StringUtils.uncapitalize(className));
        tableDO.setModelName(config.getString("model"));

        boolean visiableFlag = false;
        ...
        for (Map<String, String> column : columns) {
            ...
            if (columnName.toLowerCase().equals("visiable")) {
                visiableFlag = true;
            }
        ...
        map.put("modelName", tableDO.getModelName());
        map.put("comments", tableDO.getComments());
        map.put("pk", tableDO.getPk());
        map.put("className", tableDO.getClassName());
        map.put("classname", tableDO.getClassname());
        map.put("project", config.getString("project"));
        map.put("pathName", config.getString("project") + "." + config.getString("model"));
        map.put("columns", tableDO.getColumns());
        map.put("package", config.getString("package"));
        map.put("author", config.getString("author"));
        map.put("email", config.getString("email"));
        map.put("datetime", StringUtil.dateFormat(new Date(), StringUtil.DATE_TIME_PATTERN));
        map.put("visiableFlag", visiableFlag);
        ...
        for (String template : templates) {
            ...
            try {
                // 添加到zip
                String str = getFileName(template, tableDO.getClassname(), tableDO.getClassName(),
                    config.getString("project"), config.getString("package"), tableDO.getModelName());
    ...
    public static String tableToJava(String tableName, String tablePrefix, String autoRemovePre) {
        if (Const.AUTO_REOMVE_PRE.equals(autoRemovePre)) {
     ...
     * 获取文件名
     */
    public static String getFileName(String template, String classname, String className, String project,
        String packageName, String modelName) {
        String packagePath = "main" + File.separator + "java" + File.separator;
        // String modulesname=config.getString("packageName");
        if (StringUtils.isNotBlank(packageName)) {
            packagePath += packageName.replace(".", File.separator) + File.separator + project + File.separator;
        }
        ...
        if (template.contains("list.html.vm")) {
            return "main" + File.separator + "resources" + File.separator + "templates" + File.separator + project
                + File.separator + classname + File.separator + "list.html";
        ...
        if (template.contains("list.js.vm")) {
            return "main" + File.separator + "resources" + File.separator + "static" + File.separator + "js"
                + File.separator + "appjs" + File.separator + project + File.separator + classname + File.separator
                + "list.js";
            //
        }
