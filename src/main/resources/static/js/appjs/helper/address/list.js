        ...
        columns: [
            ...
            },
            {
                ...
                formatter: function (value, row, index) {
                    ...
                    var f = '<a class="btn btn-success btn-sm" href="#" title="备用"  mce_href="#" onclick="setDefault(\''
                        + row.addrId
...
function setDefault(id) {
    var index = layer.confirm('确定要将这个地址设为默认？', {
        btn: ['确定', '取消']
    }, function () {
        $.ajax({
            url: prefix + "/setDefault/" + id,
            type: "get",
            success: function (r) {
                if (r.code == 1) {
                    layer.msg(r.msg);
