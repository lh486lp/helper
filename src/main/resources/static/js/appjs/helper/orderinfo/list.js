var prefix = "/system/orderinfo"
$(function () {
    load();
    iniLayDateTime('payTimeBegin');
    iniLayDateTime('payTimeEnd');
    iniLayDateTime('postTimeBegin');
    iniLayDateTime('postTimeEnd');
            ...
            },
            {
                ...
                formatter: function (value, row) {
                    return row.address.province +
                        ...
                        row.address.town +
                        row.address.detail +
                        "<br> 收件人：" + row.address.receiverName +
                        "<br> 电话：" + row.address.receiverPhone;
                }
            },
            {
