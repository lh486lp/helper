...
$(function () {
    load();
    iniLayDateTime('startTimeBegin');
    iniLayDateTime('startTimeEnd');
    iniLayDateTime('endTimeBegin');
    iniLayDateTime('endTimeEnd');
    ...
    $('#exampleTable').bootstrapTable({
        ...
        columns: [
            ...
            },
            {
                ...
                formatter: function (value) {
                    var r = '';
                    var imgPaths = value.split(',');
                    for (var index in imgPaths) {
                        r += '<div><img src="' + groupfolder.getFile(imgPaths[index]) + '" width="80" style="margin: 1px;"></div>';
                    }
                    return r;
                }
            },
            {
                ...
                title: '开始时间',
                formatter: function (value) {
                    return base.formatDate(new Date(value), "yyyy-MM-dd hh:mm:ss");
                }
            },
            {
                field: 'endTime',
