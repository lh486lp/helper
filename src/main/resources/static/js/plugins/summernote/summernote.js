    ...
    */
        ...
        this.show = function () {
            ...
            this.showImageDialog().then(function (data) {
                ...
                if (typeof data === 'string') { // image url
                    ...
                    // zhoujingyu
                    // 修改选择图片后的行为，改为：上传图片到服务器

                    var upload = function (d) {
                        ...
                        $.ajax({
                            ...
                            success: function (result) {
                                if (result.code == 1) {
                                    context.invoke('editor.insertImage', window.groupfolderPath + '/getFile?fileName=' + result.msg);
    ...
    $.summernote = $.extend($.summernote, {
        ...
        options: {
            ...
            fontNames: [
                '宋体', '微软雅黑', '黑体', 'Arial', 'Arial Black', 'Comic Sans MS', 'Courier New',
